(function (namespace, $) {
	...
	// =========================================================================
	// CONDITIONAL RADION TEXT FIELD
	// =========================================================================

	$('.conditional-radio').click(function(){
        $('.reveal-if-active').addClass('active');
    });
    $('.conditional-radio-no').click(function(){
        $('.reveal-if-active').removeClass('active');

    });

    // =========================================================================
	// Add Additional Field on button click
	// =========================================================================
	$('.add-increment').click(function() {
	    $(this).before('<div class="form-group" id="increment-element"><input type="text" name="alumni" id="alumni" class="form-control" data-rule-minlength="3" required><span class="remove-increment"><i class="fa fa-minus-square" aria-hidden="true"></i> Remove Field</span><label for="alumni" class="control-label">Details of Alumni</label></div>');
	});
	$('.increment-field').on('click','.remove-increment',function() {
	 	$(this).parent().remove();
	});
	...
	$('.view-appn-detail-link').click(function(){
        $('.view-appn-detail').show();
    });

    $('.sendreminder-link').click(function(){
        $('.sendreminder').show();
    });
